  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-5 border-b border-white/10">
        ...
        {collapsed && (
          <div className="w-8 h-8 rounded-lg flex items-center justify-center mx-auto" style={{ background: 'var(--color-accent)' }}>
            <svg className="w-5 h-5" style={{ color: 'var(--color-primary-dark)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
            </svg>
          </div>
        ...
        <button
          ...
          className="text-gray-400 hover:text-gray-200 p-1 rounded transition-colors ml-auto"
        >
      ...
      <div className="border-t border-white/10 p-3">
        ...
        {!collapsed && (
          <p className="text-center text-xs mt-3 pb-1" style={{ color: 'rgba(212,219,214,0.35)' }}>
            Powered by Kodernet
          </p>
        )}
      </div>
